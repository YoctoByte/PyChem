...
class TestSmiles(unittest.TestCase):
    def test_smiles(self):
        ...
        benzene2 = Molecule(smiles='C1=CC=CC=C1')
        alanine = Molecule(smiles='O=C(O)C(N)C')
        asparagine = Molecule(smiles='O=C(N)C[C@H](N)C(=O)O')
        cephalostatin = Molecule(smiles='C[C@@](C)(O1)C[C@@H](O)[C@@]1(O2)[C@@H](C)[C@@H]3CC=C4[C@]3(C2)C(=O)C'
